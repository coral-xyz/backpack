                ...
                <div className="w-full max-w-lg">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      pl-10 pr-3 leading-5 text-gray-50 placeholder-gray-400 focus:border-white
                      focus:bg-white focus:text-gray-900 focus:outline-none focus:ring-white
                       sm:text-sm"
                      placeholder="Search"
                      type="search"
                    />
                  ...
                  <div className="flex items-center">
                    ...
                    <Menu as="div" className="relative ml-4 flex-shrink-0">
                      ...
                      >
                        ...
                        w-48 origin-top-right rounded-md bg-white py-1
