import {Message, MessageWithMetadata, SubscriptionType} from "@coral-xyz/common";
    ...
    return messages.map((message) => {
        return {
            ...
            parent_message_author_uuid: message.parent_client_generated_uuid
                ...
                : undefined,
            created_at: newMessage ? new Date().getTime().toString() : new Date(message.created_at).getTime().toString(),
        };
    });
};