import {CHAT_MESSAGES, MessageKind, MessageMetadata, SubscriptionType} from "@coral-xyz/common";
import {
    enrichMessages,
    postChat,
    updateLatestMessage,
...
export const sendMessage = async ({roomId, msg, type, userId}: {userId: string, roomId: string; msg:{
