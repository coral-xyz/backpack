CREATE TABLE "auth"."users" ("id" uuid NOT NULL DEFAULT gen_random_uuid(), "username" text NOT NULL, "password_hash" text NOT NULL, "created_at" timestamptz NOT NULL DEFAULT now(), "updated_at" timestamptz NOT NULL DEFAULT now(), "last_active_at" timestamptz NOT NULL DEFAULT now(), "invitation_id" uuid NOT NULL, PRIMARY KEY ("id") , FOREIGN KEY ("invitation_id") REFERENCES "auth"."invitations"("id") ON UPDATE cascade ON DELETE cascade, UNIQUE ("username"));
