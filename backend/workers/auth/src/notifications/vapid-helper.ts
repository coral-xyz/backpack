...
export const getVapidHeaders = (audience: any, subject: any, publicKey: any, privateKey: any, contentEncoding: any, expiration?: any) => {
    if (!audience) {
...
const ECPrivateKeyASN = asn1.define('ECPrivateKey', function() {
    ...
    thisAny.seq().obj(
        ...
        thisAny.key('parameters').explicit(0).objid()
            .optional(),
        thisAny.key('publicKey').explicit(1).bitstr()
            .optional()
    );
});