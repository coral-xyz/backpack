...
// import { themes, tokens as tTokens } from "@tamagui/theme-base";
...
export const themes2: Themes = allThemes;

export const appConfig = createTamagui({ ...config, themes: themes2 });
