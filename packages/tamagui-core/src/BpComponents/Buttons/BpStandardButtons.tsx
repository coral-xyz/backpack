...
import { type ButtonProps, Button } from "tamagui";

import { StyledText } from "../../components/index";

const BpBaseButton = forwardRef(_BpBaseButton);
export const BpPrimaryButton = forwardRef(_BpPrimaryButton);
export const BpSecondaryButton = forwardRef(_BpSecondaryButton);
export const BpPositiveButton = forwardRef(_BpPositiveButton);
export const BpLinkButton = forwardRef(_BpLinkButton);
export const BpNegativeButton = forwardRef(_BpNegativeButton);
