...
export const messagesTabChats = [
  ...
  },
  {
    chatProps: {
      id: 2104,
      friendshipId: 2104,
      last_message: '<@backpack_dev|u07450f6d-c1a4-4303-8512-55b3f3fec061> is cool',
      public_keys: [
        {
          blockchain: 'solana',
  ...
  },
  {
    chatProps: {
      id: 1897,
      friendshipId: 1897,
      last_message: 'gm to you sir, nice space, but i missed the early part of twitter space',
      public_keys: [
        {
          blockchain: 'solana',
