...
export type NftCollectionFragmentFragment = {
  __typename?: "Collection";
  id: string;
  address: string;
  image?: string | null;
  name?: string | null;
  verified: boolean;
} & { " $fragmentName"?: "NftCollectionFragmentFragment" };

export type NftNodeFragmentFragment = {
  __typename?: "Nft";
  id: string;
  address: string;
  token: string;
  ...
  collection?:
    | ({ __typename?: "Collection" } & {
        " $fragmentRefs"?: {
          NftCollectionFragmentFragment: NftCollectionFragmentFragment;
        };
      })
    | null;
} & { " $fragmentName"?: "NftNodeFragmentFragment" };
  ...
  wallet?: {
    ...
    nfts?: {
      ...
      edges: Array<{
        ...
        node: { __typename?: "Nft" } & {
          " $fragmentRefs"?: {
            NftNodeFragmentFragment: NftNodeFragmentFragment;
          };
        };
      }>;
    } | null;
...
export type UserWalletBalanceSummaryQueryVariables = Exact<{
  address: Scalars["String"];
}>;

export type UserWalletBalanceSummaryQuery = {
  __typename?: "Query";
  user?: {
    __typename?: "User";
    id: string;
...
export const NftCollectionFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "NftCollectionFragment" },
      typeCondition: {
        kind: "NamedType",
...
} as unknown as DocumentNode<NftCollectionFragmentFragment, unknown>;
export const NftNodeFragmentFragmentDoc = {
  kind: "Document",
  definitions: [
    {
      kind: "FragmentDefinition",
      name: { kind: "Name", value: "NftNodeFragment" },
      typeCondition: {
        kind: "NamedType",
...
export const WalletNftCollectionsDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "WalletNftCollections" },
      variableDefinitions: [
        {
...
export const UserWalletBalanceSummaryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "UserWalletBalanceSummary" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: {
  ...
  UserWalletBalanceSummaryQuery,
  UserWalletBalanceSummaryQueryVariables
>;
