...
export const darkTheme: Partial<Theme> & { custom: { colors: CustomColors } } =
  {
    ...baseTheme,
...
export const lightTheme: Partial<Theme> & { custom: { colors: CustomColors } } =
  {
    ...baseTheme,
