import type { BlockchainWalletDescriptor } from "@coral-xyz/secure-background/types";
...
export const selectedWalletsAtom = atom<BlockchainWalletDescriptor[]>({
  key: "selectedWalletsAtom",
  default: [],
});
