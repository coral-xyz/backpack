...
export type WalletPublicKeys = {
  [key: string]: {
    hdPublicKeys: PublicKeyMetadata[];
    importedPublicKeys: PublicKeyMetadata[];
    ledgerPublicKeys: PublicKeyMetadata[];
  };
};
...
export type ExtractRecoilType<P> =
  P extends RecoilValueReadOnly<infer T> ? T : never;
