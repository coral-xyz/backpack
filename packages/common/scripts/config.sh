...
export const BACKPACK_FEATURE_USERNAMES = ${BACKPACK_FEATURE_USERNAMES:=true};
export const BACKPACK_FEATURE_XNFT = ${BACKPACK_FEATURE_XNFT:=true};
export const BACKPACK_FEATURE_JWT = ${BACKPACK_FEATURE_JWT:=true};
export const BACKPACK_FEATURE_AGGREGATE_WALLETS = ${BACKPACK_FEATURE_AGGREGATE_WALLETS:=true};
export const BACKPACK_FEATURE_REFERRAL_FEES = ${BACKPACK_FEATURE_REFERRAL_FEES:=false};
