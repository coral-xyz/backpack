...
export const NOTIFICATION_DOMAIN_CONTENT_IPFS_GATEWAY_UPDATED =
  "notification-domain-content-ipfs-gateway-updated";
export const NOTIFICATION_ENABLED_DNS_RESOLUTION_NETWORKS_UPDATED =
  "notification-enabled-dns-resolution-networks-updated";
