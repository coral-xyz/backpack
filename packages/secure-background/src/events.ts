...
export type SecureEvent<T extends SECURE_EVENTS = SECURE_EVENTS> =
  ...
  ? SECURE_EVM_PROVIDER_SEND
  : T extends "SECURE_USER_REMOVE"
  ? SECURE_USER_REMOVE
  : T extends "SECURE_USER_REMOVE_WALLET"
  ? SECURE_USER_REMOVE_WALLET
  ...
  ? SECURE_USER_UNLOCK_KEYRING
  : T extends "SECURE_USER_LOCK_KEYRING"
  ? SECURE_USER_LOCK_KEYRING
  ...
  ? SECURE_USER_INIT_WALLET
  : T extends "SECURE_USER_PREVIEW_WALLETS"
  ? SECURE_USER_PREVIEW_WALLETS
