...
export class UserClient {
  ...
  public async previewWallets(
    request: SecureRequest<"SECURE_USER_PREVIEW_WALLETS">["request"]
  ): Promise<SecureResponse<"SECURE_USER_PREVIEW_WALLETS">> {
    return this.secureBackgroundClient.send({
      name: "SECURE_USER_PREVIEW_WALLETS",
      request,
    });
  }
  ...
  public async lockKeyring(
    request: SecureRequest<"SECURE_USER_LOCK_KEYRING">["request"] = {}
  ): Promise<SecureResponse<"SECURE_USER_LOCK_KEYRING">> {
    return this.secureBackgroundClient.send({
      name: "SECURE_USER_LOCK_KEYRING",
      request,
    });
  }
  ...
  public async removeUser(
    request: SecureRequest<"SECURE_USER_REMOVE">["request"],
    options: SecureRequestOptions<"SECURE_USER_REMOVE"> = {}
  ): Promise<SecureResponse<"SECURE_USER_REMOVE">> {
    return this.secureBackgroundClient.send({
      name: "SECURE_USER_REMOVE",
      request,
      ...options,
    });
  }
  ...
  public async removeWallet(
    request: SecureRequest<"SECURE_USER_REMOVE_WALLET">["request"],
    options: SecureRequestOptions<"SECURE_USER_REMOVE_WALLET"> = {}
  ): Promise<SecureResponse<"SECURE_USER_REMOVE_WALLET">> {
    return this.secureBackgroundClient.send({
      name: "SECURE_USER_REMOVE_WALLET",
      request,
      ...options,
    });
  }
