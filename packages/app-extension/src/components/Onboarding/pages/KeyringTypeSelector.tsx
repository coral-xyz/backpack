...
import { BpLinkButton, BpPrimaryButton, BpSecondaryButton } from "@coral-xyz/tamagui";
      ...
      >
        ...
        {showAdvancedOptions ? (
          <>
            ...
            <BpLinkButton label={t("hide_advanced_options")} onPress={() => setShowAdvancedOptions(false)} />
          </>
        ) : (
          <BpLinkButton label={t("show_advanced_options")} onPress={() => setShowAdvancedOptions(true)} />
        )}
      </Box>
    </div>
  );
