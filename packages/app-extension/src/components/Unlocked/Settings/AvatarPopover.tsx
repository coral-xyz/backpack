...
import { openAddUserAccount } from "@coral-xyz/common";
...
import { Routes as SettingsRoutes } from "../../../refactor/navigation/SettingsNavigator";
...
export function AvatarPopoverButton({
  ...
  const openSettings = () => {
    ...
    navigation.push(Routes.SettingsNavigator, {
      screen: SettingsRoutes.SettingsScreen,
    });
  };
...
export function _IncognitoAvatarFromUsername({
  index,
  username,
  variant,
}: {
