...
export function ConnectHardwareKeystoneTutorial({ onNext }: { onNext: () => void }) {
    ...
    >
      <Box px={3}>
        ...
        <Stack spacing={2} mt={3}>
          ...
          >
            <Box mr={2} color={theme.custom.colors.fontColor}>1</Box>
            <Box fontSize={14} color={theme.custom.colors.fontColor3}>
              Tap <span style={{ color: theme.custom.colors.fontColor }}>Connect Software Wallet</span> on the Keystone device
            </Box>
          </Box>
          <Box
            sx={{
          ...
          >
            <Box mr={2} color={theme.custom.colors.fontColor}>2</Box>
            <Box fontSize={14} color={theme.custom.colors.fontColor3}>
          ...
          >
            <Box mr={2} color={theme.custom.colors.fontColor}>3</Box>
            <Box fontSize={14} color={theme.custom.colors.fontColor3}>
