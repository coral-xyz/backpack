...
import type { CachedTokenBalance, SwapContext } from "@coral-xyz/recoil";
import {
  useAvailableForSwap,
  useExecuteSwap,
  useFromToken,
...
import { QuoteProvider, useQuoteContext, useSwapContext } from "./Context";
...
const ConfirmSwapButton = () => {
  ...
  const onSubmit = async (e?: any) => {
    ...
    try {
      const signature = await executeSwap(transaction ?? undefined);
  ...
  return (
    <SwapInfoRows
      {...{
        ...
        networkFee: "0.000005", // TODO: we should account for ATA account creation here as well.
        swapFee,
      }}
    />
  );
