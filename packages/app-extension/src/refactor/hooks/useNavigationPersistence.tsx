...
const INVALID_START_SCREENS = new Set([
  SwapRoutes.SwapConfirmationScreen as string,
  SendRoutes.SendConfirmationScreen as string,
  SendCollectibleRoutes.SendCollectibleConfirmationScreen as string,
  StakeRoutes.StakeConfirmationScreen as string,
]);
